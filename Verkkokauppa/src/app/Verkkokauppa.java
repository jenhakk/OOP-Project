...
//					
			...
			System.out.println("Ostostesi yhteissumma on: " + yhteissumma + "�");
			...
			if (vastaus.equalsIgnoreCase("k"))
				...
				if (vastaus.equalsIgnoreCase("jippii")) {
					...
					System.out.println("Ostostesi yhteissumma on nyt: "+ yhteissumma + " �");
					break; 
					} else {
						alennus = "0 %";
						System.out.println("V��r� koodi! Yrit� uudelleen tai jatka sy�tt�m��n asiakastietosi kirjoittamalla 'e'");
					}
